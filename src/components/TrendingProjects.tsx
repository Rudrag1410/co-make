...
export function TrendingProjects({ properties = [] }: { properties?: Property[] }) {
  return (
    <section className="py-16 bg-white relative z-10 border-t border-slate-950/5">
      <div className="container mx-auto px-6">
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <h2 className="text-2xl md:text-3xl font-serif font-bold text-slate-950 leading-tight">
              Trending <span className="italic text-gold">Off-Plan</span> Projects
            </h2>
          </div>
          <Link href="/listings" className="text-slate-950 font-bold text-[9px] uppercase tracking-widest border-b border-gold pb-1 hover:pr-3 transition-all">
            EXPLORE ALL
          </Link>
        </div>
              ...
              >
                  ...
                  <div className="relative h-[340px] rounded-[1.5rem] overflow-hidden mb-4 shadow-sm">
                    ...
                    <div className="absolute top-4 left-4">
                      <div className="bg-white/90 backdrop-blur-md px-3 py-0.5 rounded-full shadow-sm">
                        <p className="text-slate-950 text-[8px] font-bold uppercase tracking-widest">
                          {project.category}
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex items-center justify-between px-1">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-slate-950/40 text-[8px] font-bold uppercase tracking-widest">
