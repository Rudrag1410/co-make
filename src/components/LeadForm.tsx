            ...
            <div className="space-y-5">
              {[
                ...
                >
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-slate-950/5 flex items-center justify-center text-gold group-hover:bg-gold/10 transition-colors">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-white/50 text-[9px] font-bold uppercase tracking-widest">
                          Full Name
                        </FormLabel>
                        <FormControl>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="villa" className="bg-slate-950">
                                Luxury Villa
                              </option>
                              <option
                                value="apartment"
                              ...
                              <option value="offplan" className="bg-slate-950">
                                Off-Plan
                              </option>
                            </select>
                          </div>
                ...
                <Button
                  type="submit"
                  className="w-full bg-gold hover:bg-gold/90 text-slate-950 font-bold py-5 rounded-lg text-[10px] tracking-[0.2em] group"
                >
                  SEND ENQUIRY
