...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=100&w=3840&auto=format&fit=crop",
    rating: 5,
  },
];
          ...
          {TESTIMONIALS.map((t, idx) => (
            <SwiperSlide key={idx}>
              <motion.div
                ...
                className="bg-offwhite p-8 rounded-3xl border border-slate-950/5 h-full flex flex-col"
              >
                ...
                <div className="mt-auto flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <h4 className="text-slate-950 font-bold text-base">{t.name}</h4>
                    <p className="text-slate-950/40 text-[9px] font-bold uppercase tracking-widest">{t.role}</p>
                  </div>
                </div>
              </motion.div>
            </SwiperSlide>
